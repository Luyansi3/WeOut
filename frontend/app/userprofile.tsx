        ...
        >
            {
                ...
                View (Profile)
                    Image 375x282
                    View (Userinfo) 375x227
                        
                        Text (Full name)
                        Text (Username)
                        XStack
                            Icon (Followers) Icon (Parties attended)
                        XStack
                            Icon (Instagram) Icon (X) Icon (BeReal)
                        Text (Bio)
                        Horizontal Tabs 
                            Button (Past) Button (Upcoming)


                */
            }
            <Image
                style={{ width: 375, height: 282, alignSelf: 'center' }}
            />
            <YStack
                flex={1}
                gap="$2"
